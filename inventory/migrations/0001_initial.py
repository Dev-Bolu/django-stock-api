# Generated by Django 5.2.7 on 2025-10-15 18:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profit', models.DecimalField(decimal_places=2, default=0, editable=False, max_digits=10)),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='item_values', to='inventory.storeitem')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store_out', models.PositiveIntegerField(default=0)),
                ('remaining_stock', models.PositiveIntegerField(default=0)),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='history', to='inventory.storeitem')),
            ],
            options={
